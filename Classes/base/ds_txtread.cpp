...
#include "ds_mpqtypes.h"
#include "ds_txtread.h"
...
char * DsTxtRead::txt_gets(char * bptr, int * nb_char, int * is_new_line, int del_char)
{
	*is_new_line = FALSE;
	*nb_char = 0;
...
// ==========================================================================
void DsTxtRead::txt_count_header_cols(char * cur_col, int * col_count)
{
...
// ==========================================================================
char * DsTxtRead::txt_read_header(char * cur_col, TXT_S * txt)
{
...
// ==========================================================================
int DsTxtRead::txt_check_type_and_size(char * cur_col, TXT_S * txt)
{
...
// ==========================================================================
int DsTxtRead::txt_fill_data(char * cur_col, TXT_S * txt)
{
...
// ==========================================================================
TXT_S * DsTxtRead::txt_destroy(TXT_S * txt)
{
	if (txt == NULL)
		return NULL;
	if (txt->data != NULL)
...
// ==========================================================================
void DsTxtRead::txt_get_user_filter_cols(char * cur_col, TXT_S * txt)
{
	int  nb_char, is_new_line;
	char * next_col = NULL;
	int  i = 0;
...
TXT_S * DsTxtRead::txt_load(char * mem, RQ_ENUM enum_txt, char * filename)
{
	TXT_S * txt = NULL;
...
void * DsTxtRead::txt_read_in_mem(char * txtname)
{
...
// ==========================================================================
void DsTxtRead::txt_convert_slash(char * str)
{
	int i, s = strlen(str);
...
void DsTxtRead::txt_debug(char * file_path_mem, char * file_path_def, TXT_S * txt)
{
	FILE * out = NULL;
	int  i = 0;
...
// ==========================================================================
// load lvlTypes.txt in mem, then load each dt1 for a 1 ds1
int DsTxtRead::read_lvltypes_txt(int ds1_idx, int type)
{
	TXT_S * txt = NULL;
...
int DsTxtRead::read_lvlprest_txt(int ds1_idx, int def)
{
	TXT_S * txt;
	...
	{
		buff = (char*)txt_read_in_mem(lvlprest);
		if (buff == NULL)
			return -1;
...
int DsTxtRead::read_obj_txt(void)
{
	TXT_S * txt;
...
int DsTxtRead::read_objects_txt(void)
{
	TXT_S * txt;
...
int DsTxtRead::misc_get_txt_column_num(RQ_ENUM txt_idx, char * col_name)
{
	int   i = 0;
